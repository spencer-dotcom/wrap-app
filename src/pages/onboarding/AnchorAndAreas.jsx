      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            Everything in the WRAP system points here. Your anchor goal is the single most significant outcome you want to achieve in the next 3–5 years — the one that, if accomplished, would pull you through every smaller goal along the way.
          </p>
        </div>
        ...
        {/* Timeline selection */}
        <div>
          <p style={{ fontSize: '0.8rem', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 12 }}>
            Timeline
          </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <Button
            ...
            disabled={anchorGoal.trim().length < 20 || saving}
            loading={saving}
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 'var(--space-sm)' }}>
          {areas.map((area, i) => (
            ...
            >
              ...
              <span style={{ fontSize: '0.9rem', fontWeight: area.selected ? 600 : 400, color: area.selected ? 'var(--text-primary)' : 'var(--text-secondary)', flex: 1 }}>
                {area.name}
              </span>
              <div style={{
        ...
        {areas.length < 9 && (
          <div style={{
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: 10 }}>Add a custom life area</p>
            <div style={{ display: 'flex', gap: 10 }}>
              <input
                value={custom}
        ...
        <Button
          variant="primary" size="lg" fullWidth
          disabled={selectedCount < 5 || selectedCount > 9 || saving}
          loading={saving}
